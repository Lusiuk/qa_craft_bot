...
Gem::Specification.new do |spec|
  ...
  spec.description = 'QA Craft Bot - Telegram-бот для авторов тестов и их учеников:
 создание приватных тестов с доступом по коду, их прохождение,
 результаты и уведомления преподавателю.
 Поддерживает хранение в SQLite и расширяемую логику на AASM.'
